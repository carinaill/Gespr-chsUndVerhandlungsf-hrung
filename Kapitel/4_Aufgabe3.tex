...
„Kuchen vergrößern“ stellt eine Win-Win Verhandlungsstrategie dar\footnote{Vgl. \cite{kreggenfeld2021}}, bei
...
die beide Parteien aus der Einigung erzielen können. \footnote{Vgl. \cite{krebsjung2016}} 
Diese zu vergrößern, heißt dass alle Vertragsparteien ihre verfolgten Ziele erreichen. \\
Die Vergrößerung des Kuchens setzt voraus, dass sich Verhandler von der Annahme eines unveränderlichen fixed pie lösen.\footnote{Vgl. \cite{krebsjung2016}} 
Diese Annahme beruht häufig auf kognitiven Verzerrungen wie der fixed pie illusion oder dem incompatibility bias,\footnote{Vgl. \cite{krebsjung2016}} wonach Interessen der Parteien als zwingend gegensätzlich wahrgenommen werden. 
Tatsächlich bestehen jedoch vielfach Spielräume zur Wertschöpfung, etwa durch die Einbeziehung weiterer Verhandlungsdimensionen neben dem Preis, wie Lieferfristen, Qualität, Zusatzleistungen, Finanzierungsmodalitäten oder Haftungsrisiken. \footnote{Vgl. \cite{krebsjung2016}} \\
...
Es ist besonders dann sinnvoll, nach Möglichkeiten zur Vergrößerung des Verhandlungskuchens zu suchen, wenn nicht eindeutig feststeht,
dass der zu verteilende Wert von Anfang an fest begrenzt ist.
