...
\begin{itemize}
\item die Art der Argumentation (sachlich vs. emotional)
\item der Einsatz von Druck oder Beziehung
\item die Bereitschaft zu Zugeständnissen
\item der Grad an Offenheit oder Zurückhaltung
\item der Umgang mit Konflikten und Emotionen
\item Das Seminar unterscheidet unter anderem zwischen harten und weichen Verhandlungsstilen, wie sie auch im Harvard-Konzept beschrieben werden. Während harte Verhandlungstypen auf Durchsetzung, Kontrolle und das Beharren auf Positionen setzen, legen weiche Verhandlunstypen mehr Wert auf Beziehung, Harmonie und Kompromisse.
\end{itemize}
